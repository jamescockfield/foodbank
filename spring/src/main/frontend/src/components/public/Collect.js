...
var Collect = () => (
    <div className="vertical-split">
        <div>
            <p className="medium-text">This is the collections page</p>
            <p>
            ...
            <p>
                Vestibulum pretium neque lacus, imperdiet faucibus tortor pretium id. Proin finibus pharetra ligula sit amet imperdiet. Donec laoreet magna a rutrum vehicula. Maecenas ultricies vestibulum imperdiet. Nam et dui dignissim, mattis ligula et, ultricies mi. Phasellus eu maximus felis, ut malesuada nibh. Aenean molestie dapibus placerat.
                Donec hendrerit turpis vitae ex accumsan porta. Nam eu nisl urna. Ut tincidunt ut dui eu elementum. Vivamus ornare id mauris eget gravida. Cras pretium vestibulum quam sed cursus. Nulla facilisi. Aenean vitae orci aliquet, lacinia ante et, faucibus libero. Vivamus eu est rutrum, maximus dui in, faucibus erat. Curabitur ut malesuada lectus. Nullam porta vulputate justo, non condimentum libero tempor nec.
                Suspendisse blandit convallis nulla, bibendum sollicitudin justo. Proin euismod tempus enim ut finibus. Vivamus venenatis mauris quam, eu ultricies urna pellentesque vel. Phasellus nec vehicula felis. Donec quis hendrerit odio, a mattis risus. Duis sagittis nec ligula eget condimentum. Quisque nec felis et augue efficitur pharetra quis sagittis quam. Fusce et erat pretium nulla congue pharetra. Nullam interdum tincidunt nibh at convallis. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Cras faucibus rutrum lectus id bibendum.
            </p>
        </div>
        <div>
            <img alt="" src="http://localhost:8080/img/image-5.jpg"/>
        </div>
    </div>
);
